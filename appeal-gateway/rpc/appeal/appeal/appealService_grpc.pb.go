...
const (
	...
	Appeal_PassAppealTables_FullMethodName     = "/appeal.Appeal/PassAppealTables"
)
...
func (c *appealClient) PassAppealTables(ctx context.Context, in *AppealPassRequest, opts ...grpc.CallOption) (*AppealResponse, error) {
	out := new(AppealResponse)
	err := c.cc.Invoke(ctx, Appeal_PassAppealTables_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AppealServer interface {
	...
	PassAppealTables(context.Context, *AppealPassRequest) (*AppealResponse, error)
...
func (UnimplementedAppealServer) PassAppealTables(context.Context, *AppealPassRequest) (*AppealResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method PassAppealTables not implemented")
}
...
func _Appeal_PassAppealTables_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AppealPassRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AppealServer).PassAppealTables(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Appeal_PassAppealTables_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AppealServer).PassAppealTables(ctx, req.(*AppealPassRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Appeal_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "PassAppealTables",
			Handler:    _Appeal_PassAppealTables_Handler,
		},
	},
